...
class RGBDDetectionServer(Node):
    def __init__(self):
        ...
        self.label_file = os.path.join(script_dir, 'labels.txt')   # label file path
        self.grounding_dino_script = os.path.join(script_dir, 'dino_3d_location.py') # path to your detection script
