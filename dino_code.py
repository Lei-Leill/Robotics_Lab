...
'''
image = Image.open('camera_lower_Color.png')
#text_labels = [["a cube", "a square","a cylinder","a circle","a star","a block"]] 
text_labels = [["a green cylinder", "a yellow cube", "a blue cylinder", "a red triangular prism", "a red hexagonal prism", "a green cube", "a blue star", "a blue clover shape"]]
